...
const CampaignEditPage: React.FC = () => {
  ...
  // Check authentication and load campaign data
  useEffect(() => {
    if (!isLoggedIn) {
      router.push('/login?redirect=/campaigns/edit');
      return;
    } 
    ...
    if (id) {
      // Load campaign data (in production, this would be an API call)
      ...
      setFormData({
        ...
        daysToRun: campaign.daysLeft || 30,
        investmentType: campaign.investmentType === 'Cổ phần' ? 'equity' : 
                       campaign.investmentType === 'Nợ' ? 'debt' : 
                       campaign.investmentType ? campaign.investmentType : 'equity',
        expectedROI: campaign.expectedROI || 0,
        term: campaign.term || 12,
        coverImage: null,
        companyLogo: null,
        ...
        team: campaign.team || '',
        fundingPlan: campaign.fundingPlan || ''
      });
      
      setIsLoading(false);
    }
  }, [isLoggedIn, user, router, id]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({
        ...errors,
        submit: 'Có lỗi xảy ra khi cập nhật dự án. Vui lòng thử lại sau.'
      });
    } finally {
  ...
  return (
    <>
      <Head>
        <title>Chỉnh sửa dự án | SME CrowdFund VN</title>
      </Head>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              ...
              <p className="mt-2 text-gray-600">
                Cập nhật thông tin dự án gọi vốn của bạn
              </p>
            </div>
            ...
            {submitSuccess ? (
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <p className="text-sm text-green-700">
                      Dự án đã được cập nhật thành công! Đang chuyển hướng đến trang quản lý...
                    </p>
                  </div>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg p-6 mb-10">
                ...
                <div className="space-y-6">
                  ...
                  {/* Hình ảnh */}
                  <div>
                    <h2 className="text-xl font-semibold text-gray-900 mb-4">Cập nhật hình ảnh</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
