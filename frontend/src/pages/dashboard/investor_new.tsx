    ...
    setRecommendations([
      {
        ...
        rating: 4.2,
        ownerId: 1,
        owner: { id: 1, name: 'Green Energy Co.', email: 'contact@greenenergy.vn' },
        status: 'active',
    ...
    setWatchlist([
      {
        ...
        rating: 4.5,
        ownerId: 2,
        owner: { id: 2, name: 'HealthTech Co.', email: 'info@healthtech.vn' },
        status: 'active',
        ...
        <div className="bg-white shadow-sm border-b">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-6">
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Dashboard Nhà Đầu Tư</h1>
                <p className="text-gray-600">Chào mừng trở lại, {user?.name || 'Nhà đầu tư'}!</p>
              </div>
              <div className="flex space-x-4">
                <button className="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">
                  Khám phá cơ hội
                </button>
                <NotificationSystem userRole="investor" userId={user?.id} />
              </div>
            </div>
          </div>
        </div>
                  ...
                  <div key={campaign.id} className="bg-white rounded-xl shadow-sm border overflow-hidden hover:shadow-md transition-shadow">
                    ...
                    <div className="p-6">
                      ...
                      <div className="space-y-2 mb-4">
                        ...
                        <div className="flex justify-between text-sm">
                          <span className="text-gray-600">ROI dự kiến:</span>
                          <span className="font-semibold text-blue-600">{campaign.expectedROI}</span>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-xs text-gray-500">{campaign.timeline}</span>
                        </div>
                  ...
                  {watchlist.map((campaign) => (
                    <div key={campaign.id} className="border rounded-lg p-4 hover:shadow-md transition-shadow">
                      ...
                      <div className="flex justify-between text-sm mb-3">
                        ...
                        <span className="text-blue-600 font-medium">{campaign.expectedROI}</span>
                      </div>
